...
const char *zoneNames[] = { "Azure\0", "Yellow\0", "Orange\0", "Red\0" };
...
const Position positionM[nPosition] = { 0, 0, 0, 0, 0, 1, 2, 3, 1, 2, 3, 1, 3, 1, 3, 2, 2 };
const Position positionN[nPosition] = { 0, 1, 2, 3, 4, 0, 0, 0, 4, 4, 4, 1, 1, 3, 3, 1, 3 };
